...
public class PeopleController {
	...
	@PatchMapping ("/{id}")
	public String submitUpdatePerson(@Valid Person person, BindingResult bindingResult, @PathVariable("id") Integer id)
	{
		//@ModelAttribute("person")
		...
		// UPD: идеи есть, но все костыльные и вероятно нарушают всевозможные законы. Вроде как в JPA есть Unique, так что пох.
		if (bindingResult.hasErrors())
		{
			return "people/edit";
		}
